...
#              target_fieldnames=[('mse', 'min'), ('mae', 'min'), ('crps', 'min'), ('naps', 'min')],
...
# # comp qsqf MSE & MAE & CRPS & NAPS table
...
#
#
# # comp aq MSE & MAE & CRPS & NAPS table
